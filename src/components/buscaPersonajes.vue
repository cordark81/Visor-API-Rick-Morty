<template>
    <div class="mt-10 flex flex-wrap gap-5 justify-center ">
      <tipoFiltrosPersonajes class="mr-10" @vivos="filtro" @muertos="filtro" @species="filtroSpecie" @genero="filtroGenero" />
      <div
        ...
        <h1 class="font-bold">Personajes</h1>
  ...
  import tipoFiltrosPersonajes from "./tipoFiltrosPersonajes.vue";
